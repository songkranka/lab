		...
		.controller(
				...
				[
						...
						function($scope, $rootScope, $compile, $location,
							...
							$scope.cmbPostName = [ {
								value : "เจ้าหน้าที่ตรวจสอบสาขา",
								caption : 'เจ้าหน้าที่ตรวจสอบสาขา'
							}, {
								value : "เจ้าหน้าที่ปฏิบัติการ",
								caption : 'เจ้าหน้าที่ปฏิบัติการ'
							} ];
							$scope.selectedPostName = {
								value : "เจ้าหน้าที่ตรวจสอบสาขา",
								caption : 'เจ้าหน้าที่ตรวจสอบสาขา'
							};

							$scope.cmbOrgName = [ {
								value : "แผนกตรวจสอบสาขา",
								caption : 'แผนกตรวจสอบสาขา'
							} ];
