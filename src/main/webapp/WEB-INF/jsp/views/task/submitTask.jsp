...
<div class="wrapper wrapper-content animated fadeInRight" style="padding-top:0px">
                            ...
                            <div class="table-responsive">
                                ...
                                <table   id="tblForSubmitTask" class="table table-striped table-bordered" style="width: 100%;" role="grid" aria-describedby="tableApproverTask_info">
                                    ...
                                    <tr class="tbHeader" style="font-size: 14px;">
                                        ...
                                        <!-- <th class="text-center" style="width: 15%;" >SPEC2</th> -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <center>
                <button type="button" id="btnSaveResultLab" style="width: 150px;" onclick="submitJob()" class="btn btn-primary center-block">บันทึกผล <i class="fa fa-save" style="font-size:22px;color:yellow"></i></button>
            </center>
        </div>
    </div>
</div>
