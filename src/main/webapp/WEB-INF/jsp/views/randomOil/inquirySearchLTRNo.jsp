 							 ...
 							 var det = "";
 										 ...
 										 for (var i = 0; i < data.list.length; i++) {
 											...
 											det +='<td class="text-left" >'+ (i+1)+'</td>'; 
 										 	...
 										 	det +='<td class="text-center" ><a href="initInquirySaveResult?ltrNo='+(data.list[i].LTR_NO==null?"":data.list[i].LTR_NO)+'&labcode='+(data.list[i].LAB_CODE==null?"":data.list[i].LAB_CODE)+'&modeView=Y">'+(data.list[i].LTR_NO==null?"":data.list[i].LTR_NO)+'</a></td>';
 										 	...
 										 	det +='<td class="text-left" >'+(data.list[i].RESULT_STATUS==null?"":data.list[i].RESULT_STATUS)+'</td>'; 		
 											det +='</tr>';
 										}
 										// alert(det);
 										if(det==''){
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>ค้นหาผลการทดสอบ(LAB Officer)</h2>
