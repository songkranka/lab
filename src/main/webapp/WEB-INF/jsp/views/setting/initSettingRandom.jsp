	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body modal-bodycus">
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					<div class="col-xs-12 col-md-3 text-right titleInputModel">จำนวนตัวอย่างขั่นต่ำ
					</div>
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label>&nbsp;</label> <input type="text"
								class="form-control inputCus" name="cntSP" placeholder="0"
								min="0" maxlength="3"
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					<div class="col-xs-12 col-md-3 text-right titleInputModel">random
						(%)</div>
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label>&nbsp;</label> <input type="text"
								class="form-control inputCus" name="perRD" placeholder="0"
								min="0" maxlength="3"
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
					</div>
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					<div class="col-xs-12 col-md-3 text-right titleInputModel">ค่ากิโล
						(บาท/กม.)</div>
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label>&nbsp;</label> <input type="text"
								class="form-control inputCus" name="kiloAMT" placeholder="0"
								min="0" maxlength="3"
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
					</div>
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					<div class="col-xs-12 col-md-3 text-right titleInputModel">อัตราค่าเบี้ยเลี้ยง
					</div>
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label>&nbsp;</label> <input type="text"
								class="form-control inputCus" name="hotelAMT" placeholder="0"
								min="0" maxlength="5"
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
					</div>
			...
			<div class="modal-body modal-bodycus">
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					...
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label></label> <input type="text" class="form-control inputCus"
								name="updatecntSP" placeholder="0" min="0" maxlength="3"
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					...
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label></label> <input type="text" class="form-control inputCus"
								name="updateperRD" placeholder="0" min="0" maxlength="3"
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					...
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label></label> <input type="text" class="form-control inputCus"
								name="updateamtperkilo" placeholder="0" min="0" maxlength="3"
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-md-12 boxGroupCus">
					...
					<div class="col-xs-12 col-md-4 text-left form-inline">
						<div class="form-group">
							<label></label> <input type="text" class="form-control inputCus"
								name=updateamtpernighthotel placeholder="0" min="0"
								maxlength="5"
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
					</div>
					...
					<table id="myTablePlaning"
						...
						<thead>
							<tr class="tbHeader">
								...
								<th class="text-center vertical_align_inherit">จำนวนตัวอย่างขั้นต่ำ</th>
								<th class="text-center vertical_align_inherit">Random (%)</th>
								<th class="text-center vertical_align_inherit">ค่ากิโล (บาท/กม.)</th>
								<th class="text-center vertical_align_inherit">อัตราค่าเบี้ยเลี้ยง</th>
...
<script src="<c:url value="/assets/js/settingRandom.js" /> "type="text/javascript"></script>