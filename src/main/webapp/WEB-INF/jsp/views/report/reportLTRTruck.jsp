        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                   <div class="row">
                        <div class="col-xs-6"><h5>รายงาน LTR</h5></div>
                        <div class="col-xs-6 text-right"><form action="/Lab/reportLtrCondition"><input class=" btn btn-primary" style="border-radius: 3px;margin-top: 10px;" id="condtionbtn" type="submit" value="Nonconform Type"></form></div>
                    </div>
                        ...
                        <div class="ibox-content">
                           ...
                           <div class="row">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group" style="text-align: left">
                                        <div class="col-sm-3">
										<input type="checkbox" value="A" checked="checked" id="apass"/>&nbsp&nbsp<span>ผ่าน</span>
										</div>
										<div class="col-sm-3">
										<input type="checkbox" value="N" checked="checked" id="npass"/>&nbsp&nbsp<span>ไม่ผ่าน</span>
										</div>
										<div class="col-sm-3">
										<input type="checkbox" value="U" checked="checked" id="upass"/>&nbsp&nbsp<span>ผ่านแบบมีเงื่อนไข</span>	
										</div>
                                    </div>
                                </div>
                            </div>
